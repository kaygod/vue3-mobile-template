...
import { Modal } from '@/util/createMsg';
import ComfirmComponent from '@/components/Confirm/index.vue';
import Loading from '@/components/Loading/index.vue';
export const service_ip = 'https://m.wayforcloud.com/project4';

//打开loaidng
export const showLoading = () => {
  Loading._instance = Modal(Loading, {});
};

//关闭loading
export const closeLoading = () => {
  if (Loading._instance && Loading._instance.destory) {
    Loading._instance.destory();
  ...
  return new Promise<K>((resolve, reject) => {
    ...
    axios({
      ...
      .then((res: AxiosResponse<T>) => {
        ...
        const rResult = res.data as {result:number,data:any,errno:string};
